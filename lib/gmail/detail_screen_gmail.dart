...
class DetailScreenGmail extends StatefulWidget {
  final String imagePath;

  const DetailScreenGmail({required this.imagePath});

  @override
  _DetailScreenGmailState createState() => _DetailScreenGmailState();
}

class _DetailScreenGmailState extends State<DetailScreenGmail> {
